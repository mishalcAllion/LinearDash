...
const Theme = {
  ...
  severityColor(severity) {
    const map = {
      ...
      'S1-Critical': { bg: 'bg-orange-500/10', text: 'text-orange-400', border: 'border-orange-500/30', dot: 'bg-orange-500', hex: '#f97316', ring: 'ring-orange-500/20' },
  ...
  statusColor(status) {
    const map = {
      ...
      'Dev In Progress':      { bg: 'bg-cyan-500/10', text: 'text-cyan-400', border: 'border-cyan-500/30', dot: 'bg-cyan-500', hex: '#06b6d4' },
      'Dev Complete':         { bg: 'bg-teal-500/10', text: 'text-teal-400', border: 'border-teal-500/30', dot: 'bg-teal-500', hex: '#14b8a6' },
      'Ready for QA':         { bg: 'bg-yellow-500/10', text: 'text-yellow-400', border: 'border-yellow-500/30', dot: 'bg-yellow-500', hex: '#eab308' },
      'QA Completed':         { bg: 'bg-lime-500/10', text: 'text-lime-400', border: 'border-lime-500/30', dot: 'bg-lime-500', hex: '#84cc16' },
